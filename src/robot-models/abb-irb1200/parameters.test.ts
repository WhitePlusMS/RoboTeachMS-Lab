...
describe('ABB IRB 1200-5/0.9 profile', () => {
  it('使用官方手册的六轴关节范围', () => {
    expect(ABB_JOINT_RANGES).toEqual([
      [-170, 170],
      [-100, 130],
      [-200, 70],
      [-270, 270],
  ...
  it('保留报告中 5/0.9 URDF 等价链映射后的 DH 候选长度', () => {
    ...
    expect([dh.joint1.d, dh.joint2.a, dh.joint3.a, dh.joint4.d, dh.joint6.d]).toEqual([
      399.1, 448, 42, 451, 82,
    ])
    ...
    expect(ABB_MECHANICAL_ZERO_JOINTS).toEqual([0, 0, 0, 0, 30, 0])
